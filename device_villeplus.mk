...
$(call inherit-product-if-exists, vendor/htc/villeplus/villeplus-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/htc/villeplus/overlay

LOCAL_PATH := device/htc/villeplus
